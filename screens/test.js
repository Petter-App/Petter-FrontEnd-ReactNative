...
import { SafeAreaView, View, FlatList, StyleSheet, Tile,Text, StatusBar } from 'react-native';
...
Analytics.configure({ disabled: true })
  ...
  const backgroundImage = { uri: "https://storage.pixteller.com/designs/designs-images/2020-07-02/02/paws-placeholder-1-5efd20a15f0f0.png" };
  
  // const profile = data.map(({image }, i) => (
  //   return (
            ...
            <View style={styles.viewStyle}>
              <View>
                ...
                <LinearGradient colors={['#FF008A', '#FF4D00']} start={[0.3, 0.1]} style={styles.linearCircle}>
                  ...
                  <Image source={profile} style={styles.childStyle1} />
                </LinearGradient>
              </View>
              <View style={styles.childStyle}>
  
                <View style={styles.childTitle}>
                  <Text style={styles.petName}>{CardDetails}</Text>
                </View>
